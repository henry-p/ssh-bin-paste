...
use crate::assets::{CLIPBOARD_CAPTURE_SWIFT, write_temp_asset};
...
pub fn capture_clipboard_payload() -> Result<CapturedPayload> {
    let script = write_temp_asset("clipboard-capture.swift", CLIPBOARD_CAPTURE_SWIFT)?;
